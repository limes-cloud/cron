...
func (m *GetTaskReply) validate(all bool) error {
	...
	if m.WorkerGroup != nil {
		...
		if all {
			switch v := interface{}(m.GetWorkerGroup()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GetTaskReplyValidationError{
						field:  "WorkerGroup",
		...
		} else if v, ok := interface{}(m.GetWorkerGroup()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return GetTaskReplyValidationError{
					field:  "WorkerGroup",
					reason: "embedded message failed validation",
...
func (m *CreateTaskRequest) validate(all bool) error {
	...
	if utf8.RuneCountInString(m.GetWorkerType()) < 1 {
		err := CreateTaskRequestValidationError{
			field:  "WorkerType",
			reason: "value length must be at least 1 runes",
		}
...
// Validate checks the field values on UpdateTaskStatusReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on UpdateTaskStatusReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateTaskStatusReplyMultiError, or nil if none found.
func (m *UpdateTaskStatusReply) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateTaskStatusReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UpdateTaskStatusReplyMultiError(errors)
	}

	return nil
}

// UpdateTaskStatusReplyMultiError is an error wrapping multiple validation
// errors returned by UpdateTaskStatusReply.ValidateAll() if the designated
// constraints aren't met.
type UpdateTaskStatusReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateTaskStatusReplyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateTaskStatusReplyMultiError) AllErrors() []error { return m }

// UpdateTaskStatusReplyValidationError is the validation error returned by
// UpdateTaskStatusReply.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e UpdateTaskStatusReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateTaskStatusReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateTaskStatusReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateTaskStatusReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateTaskStatusReplyValidationError) ErrorName() string {
	return "UpdateTaskStatusReplyValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateTaskStatusReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateTaskStatusReply.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateTaskStatusReplyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateTaskStatusReplyValidationError{}
...
// Validate checks the field values on CancelExecTaskReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on CancelExecTaskReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CancelExecTaskReplyMultiError, or nil if none found.
func (m *CancelExecTaskReply) ValidateAll() error {
	return m.validate(true)
}

func (m *CancelExecTaskReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CancelExecTaskReplyMultiError(errors)
	}

	return nil
}

// CancelExecTaskReplyMultiError is an error wrapping multiple validation
// errors returned by CancelExecTaskReply.ValidateAll() if the designated
// constraints aren't met.
type CancelExecTaskReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CancelExecTaskReplyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CancelExecTaskReplyMultiError) AllErrors() []error { return m }

// CancelExecTaskReplyValidationError is the validation error returned by
// CancelExecTaskReply.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e CancelExecTaskReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CancelExecTaskReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CancelExecTaskReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CancelExecTaskReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CancelExecTaskReplyValidationError) ErrorName() string {
	return "CancelExecTaskReplyValidationError"
}

// Error satisfies the builtin error interface
func (e CancelExecTaskReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCancelExecTaskReply.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CancelExecTaskReplyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CancelExecTaskReplyValidationError{}

// Validate checks the field values on GetTaskReply_Group with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on GetTaskReply_Group with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetTaskReply_GroupMultiError, or nil if none found.
func (m *GetTaskReply_Group) ValidateAll() error {
	return m.validate(true)
}

func (m *GetTaskReply_Group) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetTaskReply_GroupMultiError(errors)
	}

	return nil
}

// GetTaskReply_GroupMultiError is an error wrapping multiple validation errors
// returned by GetTaskReply_Group.ValidateAll() if the designated constraints
// aren't met.
type GetTaskReply_GroupMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetTaskReply_GroupMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetTaskReply_GroupMultiError) AllErrors() []error { return m }

// GetTaskReply_GroupValidationError is the validation error returned by
// GetTaskReply_Group.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e GetTaskReply_GroupValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetTaskReply_GroupValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetTaskReply_GroupValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetTaskReply_GroupValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetTaskReply_GroupValidationError) ErrorName() string {
	return "GetTaskReply_GroupValidationError"
}

// Error satisfies the builtin error interface
func (e GetTaskReply_GroupValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetTaskReply_Group.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetTaskReply_GroupValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetTaskReply_GroupValidationError{}

// Validate checks the field values on GetTaskReply_Worker with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on GetTaskReply_Worker with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetTaskReply_WorkerMultiError, or nil if none found.
func (m *GetTaskReply_Worker) ValidateAll() error {
	return m.validate(true)
}

func (m *GetTaskReply_Worker) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetTaskReply_WorkerMultiError(errors)
	}

	return nil
}

// GetTaskReply_WorkerMultiError is an error wrapping multiple validation
// errors returned by GetTaskReply_Worker.ValidateAll() if the designated
// constraints aren't met.
type GetTaskReply_WorkerMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetTaskReply_WorkerMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetTaskReply_WorkerMultiError) AllErrors() []error { return m }

// GetTaskReply_WorkerValidationError is the validation error returned by
// GetTaskReply_Worker.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e GetTaskReply_WorkerValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetTaskReply_WorkerValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetTaskReply_WorkerValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetTaskReply_WorkerValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetTaskReply_WorkerValidationError) ErrorName() string {
	return "GetTaskReply_WorkerValidationError"
}

// Error satisfies the builtin error interface
func (e GetTaskReply_WorkerValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetTaskReply_Worker.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetTaskReply_WorkerValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetTaskReply_WorkerValidationError{}

// Validate checks the field values on GetTaskReply_WorkerGroup with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on GetTaskReply_WorkerGroup with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetTaskReply_WorkerGroupMultiError, or nil if none found.
func (m *GetTaskReply_WorkerGroup) ValidateAll() error {
	return m.validate(true)
}

func (m *GetTaskReply_WorkerGroup) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetTaskReply_WorkerGroupMultiError(errors)
	}

	return nil
}

// GetTaskReply_WorkerGroupMultiError is an error wrapping multiple validation
// errors returned by GetTaskReply_WorkerGroup.ValidateAll() if the designated
// constraints aren't met.
type GetTaskReply_WorkerGroupMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetTaskReply_WorkerGroupMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetTaskReply_WorkerGroupMultiError) AllErrors() []error { return m }

// GetTaskReply_WorkerGroupValidationError is the validation error returned by
// GetTaskReply_WorkerGroup.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e GetTaskReply_WorkerGroupValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetTaskReply_WorkerGroupValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetTaskReply_WorkerGroupValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetTaskReply_WorkerGroupValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetTaskReply_WorkerGroupValidationError) ErrorName() string {
	return "GetTaskReply_WorkerGroupValidationError"
}

// Error satisfies the builtin error interface
func (e GetTaskReply_WorkerGroupValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetTaskReply_WorkerGroup.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetTaskReply_WorkerGroupValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetTaskReply_WorkerGroupValidationError{}
